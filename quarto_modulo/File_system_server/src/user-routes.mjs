import fs from 'node:fs/promises' //faccio /promises ckè alla riga 20 ho una promeses
...
await fs.writeFile(DB_PATH, JSON.stringify(users, null, '  '))  //Questa riga permette il salvataggio nel file system!!!
